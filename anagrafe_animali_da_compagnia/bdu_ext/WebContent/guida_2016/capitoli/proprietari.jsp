...
<h3 id="proprietari/detentori">Proprietari/Detentori</h3>

				<br> Nel modulo proprietari/detentori, &egrave possibile fare
				due operazioni:
				<ul>
			...
			Per effettuare la ricerca dei proprietari gi&agrave presenti in
			anagrafica, &egrave indispensabile selezionare una tra le tipologie
			proprietari. Cliccando sul link "Tipologia Proprietario", si apre una
			popup in cui l'utente deve spuntare una o pi&ugrave tipologie di
			proprietario/detentore tra quelle presenti nell'elenco, ovvero:
			PRIVATO, Sindaco, Operatore Commerciale / Importatore, Canile,
			Operatore Commerciale, SINDACO_FR, Colonia. Gli altri campi presenti
			nella maschera tipo ASL, COMUNE, PARTITA IVA, CODICE FISCALE,
			NOMINATIVO PROPRIETARIO/DETENTORE, sono valorizzabili
			facoltativamente.<br> <br> <IMG
				SRC="images/propriet_detent/Imm_propr2.PNG"
				NAME="propriet_detent2.PNG" /><br> <br>
			...
			Non &egrave; consentito l'inserimento degli operatori commerciali e dei canili campani in bdu. Il loro inserimento deve avvenire tramite Suap/Scia in Gisa.<br/>
I canili fuori regione possono essere inseriti in bdu previa comunicazione all'Help Desk.<br/>
Gli utenti liberi professionisti non sono abilitati abilitati ad inserire proprietari.<br>
			Nella maschera di inserimento del proprietario, per inserire i dati della residenza si deve cliccare sul link 'Seleziona Indirizzo' e inserire i dati nella popup che si apre. Dopo aver completato la compilazione, cliccare su "Prosegui". La popup sarà chiusa e nella maschera di inserimento del proprietario saranno mostrati i dati inseriti. Per modificare i dati cliccare nuovamente su 'Seleziona Indirizzo'. Di seguito vengono riportate le immagini con il link 'Seleziona Indirizzo' da utilizzare e la popup che si apre. <br>
			
				<IMG SRC="images/propriet_detent/cap_seleziona_indirizzo.jpg" NAME="cap_seleziona_indirizzo.jpg" /> <br> 
				<IMG SRC="images/propriet_detent/cap_popup.jpg" NAME="cap_popup.jpg" /> <br><br>
			...
			successivo. <br> 
			Per inserire l'indirizzo della colonia seguire le istruzioni per l'inserimento della residenza illustrate nel paragrafo 'Aggiungi proprietario'<br> <br>
			...
			incongruenze. Da notare, per&ograve;, che &egrave possibile inserire un
			...
			<br>
			<br>
			<H2>Trasferimento Animali Massivo</H2>
			La funzionalit&agrave; permette di effettuare una registrazione di 'Trasferimento a Canile' selezionando tutti o parte degli 
			animali presenti nel canile.</br>
			Questa funzione &egrave; disponibile solo su proprietari di tipo 'Canile' e per utenti Help Desk, il pulsante 'Trasferimento animali massivo' &egrave; visibile
			solo in questi casi (come da immagine successiva).</br>
			<IMG SRC="images/propriet_detent/trasf_massivo.jpg" NAME="trasf_massivo.jpg"/ ></br>
			Cliccando sul pulsante viene mostrato il modulo in cui si pu&ograve; specificare:</br>
			<ul>
			<li>Data trasferimento: &egrave; la data che andr&agrave; sull'evento di 'Trasferimento a canile' creato per ogni singolo animale;</li>
			<li>Canile: si pu&ograve; selezionarlo cliccando su 'Ricerca' e scegliendolo dalla popup che si apre dove &egrave; possibile cercare solo detentori di tipo 'Canile';</li>
			<li>Animali coinvolti nel trasferimento massivo: l'elenco comprende animali vivi, non smarriti, non rubati ed aventi come detentore il canile corrente.</li>
			</ul>
			Spuntando 'Includi tutti gli animali' vengono selezionati automaticamente tutti gli animali.</br>
			Dopo aver compilato tutti i dati (data, canile e almeno un animale sono obbligatori) il sistema elabora la richiesta e:</br>
			1. Crea una registrazione di 'Trasferimento a Canile' </br>
			2. Nella data selezionata </br>
			3. Verso il canile indicato </br>
			4. Per ogni animale selezionato.</br>
			<IMG SRC="images/propriet_detent/trasf_massivo2.jpg" NAME="trasf_massivo2.jpg"/ >
