...
<!-- ------------------------------------------------------------------------------------------------------------ -->
			...
			<tr  id="mancata_tracciabilita" class="containerBody">
				...
				&nbsp;<b>Clicca <a href="javascript:popURL('guida_2016/guida.jsp?#provenienzaanimale','CRM_Help','1000 ','500','yes','yes');" onclick="document.getElementById('flagSenzaOrigine').disabled=false;document.getElementById('flagSenzaOrigine').style.display='';">QUI</a> per maggiori dettagli</b><br/> 
				</td>
			</tr>
...
function win_open_add_proprietario(tipologiaSoggetto, popup, id_linea){
	if(document.getElementById('flagFuoriRegione_propr')!= null && document.getElementById('flagFuoriRegione_propr').checked) {
		win= window.open('OperatoreAction.do?command=Add&estero=no&tipologiaSoggetto='+tipologiaSoggetto+'&<%=lineaProduttivaFiltro%>&popup='+popup+'&idLineaProduttiva='+id_linea+'&in_regione=no','','scrollbars=1,width=800,height=600');
	  }else{
	...
	function win_open_search_proprietario(tipologiaSoggetto, popup){
		if(document.getElementById('flagFuoriRegione_propr')!= null && document.getElementById('flagFuoriRegione_propr').checked) {
			win= window.open('OperatoreAction.do?command=SearchForm&estero=no&tipologiaSoggetto='+tipologiaSoggetto+'&popup='+popup+'&in_regione=no','','scrollbars=1,width=800,height=600');
	  }else{
