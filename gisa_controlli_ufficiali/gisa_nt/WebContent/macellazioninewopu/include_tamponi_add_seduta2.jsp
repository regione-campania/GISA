...
<%@page import="org.aspcfs.modules.macellazioninewopu.base.Tampone"%>
<%@page import="org.aspcfs.modules.macellazioninewopu.base.TipoRicerca"%>
...
<table class="details" width="100%" border="0" cellpadding="5" cellspacing="0">
    			<tr>
    				<th colspan="4">Effettuato Tampone <input type = "checkbox" id="checkTampone" name = "checkTampone" onclick="setTampone(<%=OrgDetails.getAltId() %>,<%=Partita.getCd_seduta_macellazione() %>)" > </th>
    			</tr>
    			...
    			<tr class="containerBody" id ="tampon1" value = "-1" style="display:none;" >
...
%>
    					<%=AnalisiTamponi.getHtmlSelect( "id_tipo_ricerca" , -1 ) %>
    				</td>
