...
<tbody>
	...
	<tr id="tr_data_cessazione" style="display: none">
		...
		<td>
			<input placeholder="DATA CESSAZIONE<% if(!flagLineeScia){ %>/REVOCA <% } %>" type="text" id="data_cessazione" name="data_cessazione" autocomplete="off" onkeydown="return false" size="15" style="text-align:center;">
		</td>
	</tr>
