...
<%-- 
  ...
  - 
  - Version: $Id: mycfs_inbox_menu.jsp 18832 2007-01-26 19:21:02Z matt $
  - Description: 
  --%>
...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    window.location.href='Messaggi.do?command=CFSNoteDetails&id=' + thisNoteId;
  }
  
  function sendToInbox() {
    window.location.href='Messaggi.do?command=CFSNoteTrash&id='+ thisNoteId +'&type='+ thisTypeId +'&return=list';
  }
  ...
  function reply() {
    window.location.href='Messaggi.do?command=ReplyToMessage&id=' + thisNoteId + '&return=list&forwardType=' + thisTypeId;
  }
