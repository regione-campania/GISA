...
function verificaEsistenzaOperatore()
{
	...
	PopolaCombo.controlloEsuistenzaNumRegistrazioneOpNonAltrove(num_registrazione,verificaEsistenzaOperatoreCallback ) ;
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
 ...
 <tr>
  ...
  <tr class="containerBody">
    <td class="formLabel" nowrap id="latitude2"><dhv:label name="requestor.address.latitude">Latitudine</dhv:label></td>
    <td>
  ...
  <tr class="containerBody">
    <td class="formLabel" nowrap id="longitude2"><dhv:label name="requestor.address.longitude">Longitudine</dhv:label></td>
    <td>
    	<%-- <input type="text" id="address2longitude" name="address2longitude" size="30" value="<%=AddressSedeOperativa.getLongitude() %>" id="longitude12">--%>
 ...
 <tr>
  ...
  <tr class="containerBody">
    ...
    <td>
       	<%-- <input type="text" id="address2longitude" name="address2longitude" size="30" value="<%=AddressSedeOperativa.getLongitude() %>" id="longitude12">--%>
    	<input type="text" id="address2latitude"  readonly="readonly" name="address2latitude" size="30" value="">
  ...
  <tr class="containerBody">
    ...
    <td>
    	<%-- <input type="text" id="address2longitude" name="address2longitude" size="30" value="<%=AddressSedeOperativa.getLongitude() %>" id="longitude12">--%>
    	<input type="text" id="address2longitude"  readonly="readonly" name="address2longitude" size="30" value="">
    </td>
    </tr>
    <tr style="display: block">
    <td colspan="2">
