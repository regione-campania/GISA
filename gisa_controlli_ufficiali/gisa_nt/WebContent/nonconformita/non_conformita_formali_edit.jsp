        ...
        <tr id = "nc_formali_<%=elementoNc.getProgressivo_nc() %>" >
         ...
         <td>
        	...
        	%>
        		...
        		Provvedimenti.setJsEvent("onchange=abilitaFlagFormali();abilitaStatoFormali('"+CU.getId()+"');sevValueNcFormaliModify("+i+"); gestisciBenessereNonConformita(this)"); %>
