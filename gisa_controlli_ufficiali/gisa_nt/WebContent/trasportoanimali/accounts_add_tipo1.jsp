...
il tasto Ctrl) </dhv:label>
      ...
      %>
				<input  type="text" id="dataNascitaRappresentante" name="dataNascitaRappresentante" size="10" value = "<%= (OrgDetails.getDataNascitaRappresentante()!=null) ? sdf.format(new java.util.Date(OrgDetails.getDataNascitaRappresentante().getTime())) : ""  %>" />
