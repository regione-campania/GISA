...
function popContactsListMultipleNew(displayFieldId, highLightedId, params) {
  title  = 'Motivazioni';
  width  =  '700';
  height =  '425';
  resize =  'yes';
  ...
  var newwin=window.open('TroubleTicketsSanzioni.do?command=ContactList&previousSelection=' + selectedIds + '&previousSelectionDisplay=' + selectedDisplays + '&listType=list&flushtemplist=true&selectedIds='+highLightedId+'&displayFieldId='+displayFieldId + params, title, windowParams);
  newwin.focus();
  if (newwin != null) {
    if (newwin.opener == null)
      newwin.opener = self;
