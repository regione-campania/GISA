...
function allegaFile(form,gotoPage)
{
	...
	document.forms[form].action = "OperatoriprivatiVigilanza.do?command=UploadListaDistribuzione&goto="+gotoPage;
	formTest = true;
	message = "";
...
function eliminaFileAllegato(fid,orgId,folderid,form,gotoPage)
{
	...
	document.forms[form].encoding="multipart/form-data";
	document.forms[form].action = "OperatoriprivatiVigilanza.do?command=DeleteListaDistribuzione&goto="+gotoPage+"&fid="+fid+"&orgId="+orgId+"&folderId="+folderid;
	document.forms[form].submit;
}
