...
//                             }
                ...
                input = $( "<input "+ readonly +" type='text'  id='"+select[0].id+"input' class='"+select[0].className +"' name='"+select[0].id+"input' onclick='pulisciCampo(this)' onclick='ripristinaCampo(this)' placeholder='"+placeholder+"' size='50'>" )
                    .appendTo( wrapper )
                    .val( trim(value) )
                    .attr( "title", "" )
