...
ClusterIcon.prototype.onAdd = function() {
  ...
  if (this.visible_) {
    ...
    this.div_.setAttribute("class","marker_circle");
...
ClusterIcon.prototype.show = function() {
  if (this.div_) {
    ...
    this.div_.style.className = 'marker_circle';
  }
  this.visible_ = true;
};
