...
document.forms[form].action = "AbusivismiVigilanza.do?command=UploadListaDistribuzione&goto="+gotoPage;
formTest = true;
message = "";
...
function eliminaFileAllegato(fid,orgId,folderid,form,gotoPage)
{
	...
	document.forms[form].encoding="multipart/form-data";
document.forms[form].action = "AbusivismiVigilanza.do?command=DeleteListaDistribuzione&goto="+gotoPage+"&fid="+fid+"&orgId="+orgId+"&folderId="+folderid;
