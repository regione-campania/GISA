 	...
 	alert('Selected ' + dates);
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				prevText: '&lt;Prec',
				prevStatus: 'Mostra mese precedente',
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'Mostra anno precedente',
				nextText: 'Succ&gt;',
				nextStatus: 'Mostra mese successivo',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'Mostra anno successivo',
				currentText: 'Corrente',
				currentStatus: 'Mostra mese corrente',
				todayText: '',
				todayStatus: 'Mostra giorno attuale',
				clearText: 'Pulisci',
				clearStatus: 'Pulisci tutte le date',
				closeText: 'Chiudi',
				...
				defaultStatus: 'Seleziona una data',
				isRTL: false
			}
		},
