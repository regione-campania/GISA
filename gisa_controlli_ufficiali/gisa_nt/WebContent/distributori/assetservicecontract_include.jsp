     ...
     <table cellspacing="0" cellpadding="0" border="0" class="empty">
      <tr>
        ...
        <td>
          ...
          &nbsp [<a href="javascript:popURL('AccountsServiceContractsAbus.do?command=HoursHistory&id=<%= serviceContract.getId() %>&popup=true&popupType=inline','Details','650','500','yes','yes');"><dhv:label name="accountsassets.history.long_html">History</dhv:label></a>]
          </dhv:evaluate>&nbsp;
        </td>
        </tr>
      </table>
