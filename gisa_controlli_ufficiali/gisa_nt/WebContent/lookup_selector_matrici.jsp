...
<form name="elementListView" method="post" action="LookupSelector.do?command=PopupSelectorCustomMatrici">
<br />
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="pagedList">
  ...
  <tr class="row<%= rowid %>">
    <td valign="center">
      <a href="javascript:setParentValue_matrice(<%= code %>,'<%= StringUtils.jsStringEscape(description) %>','<%= DisplayFieldId2 %>','<%= StringUtils.jsStringEscape(shortDescription) %>');">
        <%= toHtml(description) %>
      </a>
    </td>
