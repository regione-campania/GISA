...
<tr><th>Importo totale versamento</th> <td colspan="2"><input type="number" readonly id="importoTotaleVersamento_1" name="importoTotaleVersamento_1" value="<%=(int) SanzioneDettaglio.getPagamento()%>"/></td></tr>

<% if (SanzioneDettaglio.getSequestroRiduzione()>0){ %>
...
<tr><th>Importo totale versamento</th> <td colspan="2"><input type="number" readonly id="importoTotaleVersamento_2" name="importoTotaleVersamento_2" value="<%=SanzioneDettaglio.getSequestroRiduzione()%>"/></td></tr>
