...
{
window.opener.document.details.action='TroubleTicketsAllerte.do?command=ChiudiAllerta&tipoAlimenti='+tipoAlimenti+'&specie_alimenti='+specie_alimenti+'&id='+id+'&parentId=-1&folderId=-1&documentiAllerta=1&chiusuraUfficio=1&motivo_chiusura='+form.motivo_chiusura.value;
...
<form method="post" name ="chiusura" action = "TroubleTicketsAllerte.do?command=ChiudiAllerta&tipoAlimenti=<%=tipoAlimenti%>&specie_alimenti=<%=specie_alimenti %>&id=<%=id%>&parentId=-1&folderId=-1&documentiAllerta=1&chiusuraUfficio=1">
