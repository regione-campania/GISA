  ...
  <tr>
    <td nowrap width="100%"><table width="100%" class="empty">
        ...
        <tr><td nowrap colspan="2" align="left">
          <strong><dhv:label name="">Campionato: </dhv:label></strong>
    ...
    <%-- td nowrap align="right">
      ...
      <a href="TroubleTicketsCampioni.do?command=PrintReport&id=<%= thisTicket.getId() %>"><dhv:label name="accounts.tickets.print">Printable Ticket Form</dhv:label></a>
    </td --%>
  </tr>
  <tr>
    <%--td nowrap width="100%">
