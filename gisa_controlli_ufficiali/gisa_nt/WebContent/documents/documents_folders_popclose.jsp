...
<%
  ...
  if (returnPage != null) {
    ...
    if ("RequestorDocuments".equals(returnPage)) {
        location = "RequestorDocuments.do?command=View&orgId="+ param;
      }
    if ("AccountsDocumentsAllev".equals(returnPage)) {
        location = "AccountsDocumentsAllev.do?command=View&orgId="+ param;
      }
    if ("AccountsDocumentsStab".equals(returnPage)) {
    	 location = "AccountsDocumentsStab.do?command=View&orgId="+ param;
    }
    if ("TrasportoAnimaliDocuments".equals(returnPage)) {
   	 location = "TrasportoAnimaliDocuments.do?command=View&orgId="+ param;
   }
    if ("TrasportoAnimaliDocumentsFolders".equals(returnPage)) {
      	 location = "TrasportoAnimaliDocuments.do?command=View&orgId="+ param;
      }
    ...
    if ("AccountsDocumentsOsmRegistrati".equals(returnPage)) {
        location = "AccountsDocumentsOsmRegistrati.do?command=View&orgId="+ param;
      }
  }
  if (location == null) {
%>
