...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
  ...
  <tr class="containerBody">
    <td class="formLabel">
      <dhv:label name="allevamenti.allevamenti_add.Type">Type</dhv:label>
    </td>
    <td>
      ...
      <tr>
        ...
        <td>
          ...
          <% if(serviceContract.getImpiantoId() == -1) {%>
            ...
            [<a href="javascript:popListaImpianti('assetId','addAsset', 'filters=allassets|allassetsandcomponenti','ubicazioneId','addUbicazione');"><dhv:label name="allevamenti.allevamenti_add.select">Select</dhv:label></a>]
 ...
 <tr class="containerBody">
  ...
  <tr class="containerBody">
    ...
    <td>
    <input readonly type="text" id="initialStartDate" name="initialStartDate" size="10" value="<%= toDateString(serviceContract.getInitialStartDate()) %>"/>
		<a href="#" onClick="cal19.select(document.forms[0].initialStartDate,'anchor19','dd/MM/yyyy'); return false;" NAME="anchor19" ID="anchor19">
  ...
  <tr class="containerBody">
    ...
    <td>
    <input readonly type="text" id="currentEndDate" name="currentEndDate" size="10" value="<%= toDateString(serviceContract.getCurrentEndDate()) %>"/>
		<a href="#" onClick="cal19.select(document.forms[0].currentEndDate,'anchor19','dd/MM/yyyy'); return false;" NAME="anchor19" ID="anchor19">
		<img src="images/icons/stock_form-date-field-16.gif" border="0" align="absmiddle"></a>
  ...
  <tr class="containerBody">
    ...
    <td>
    <input readonly type="text" id="currentStartDate" name="currentStartDate" size="10" value="<%= toDateString(serviceContract.getCurrentStartDate()) %>"/>
  ...
  <tr class="containerBody">
    ...
    <td>
    <input readonly type="text" id="dataDecorrenzaAdeguamento" name="dataDecorrenzaAdeguamento" size="10" value="<%= toDateString(serviceContract.getDataDecorrenzaAdeguamento()) %>"/>
		<a href="#" onClick="cal19.select(document.forms[0].dataDecorrenzaAdeguamento,'anchor19','dd/MM/yyyy'); return false;" NAME="anchor19" ID="anchor19">
		<img src="images/icons/stock_form-date-field-16.gif" border="0" align="absmiddle"></a>
     ...
     <table cellspacing="0" cellpadding="0" border="0" class="empty">
      <tr>
        ...
        <td>
          ...
          &nbsp [<a href="javascript:popURL('AccountsServiceContractsAllev.do?command=HoursHistory&id=<%= serviceContract.getId() %>&popup=true&popupType=inline','Details','650','500','yes','yes');"><dhv:label name="accountsassets.history.long_html">History</dhv:label></a>]
          </dhv:evaluate>&nbsp;
        </td>
        </tr>
      </table>
