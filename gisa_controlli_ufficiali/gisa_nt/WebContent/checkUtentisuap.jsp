...
if(sessionManager != null){
	sessions = sessionManager.getSessionsSuap();
}
...
for(Object o : sessions.keySet()){
	s = (UserSession)sessions.get(o.toString());
	
	u = thisSystem.getUser(s.getUserId());	
...
<td>
<%=u.getUsername() + " cf " + u.getSuap().getCodiceFiscaleRichiedente() + u.getSuap().getCallbackSuapKo() %>
</td>
<td>
...
<%= (userb.getTimeConnopen()!=null) ? "<img src ='rosso.gif'/><br>"+  formattaMillisecondi(adesso.getTime() - userb.getTimeConnopen().getTime() ) : "<img src ='verde.gif'/><br>" %>
	...
	<%} catch (IllegalStateException ise) {
       ...
       out.print("Errore  : "+ise.getMessage());
