...
<table class="details" width="100%" border="0" cellpadding="5" cellspacing="0">
    			<tr>
    				<th colspan="4">Effettuato Tampone <input type = "checkbox" id="checkTampone" <%if(Tampone.getId()>0){%> checked="checked"<%} %> name = "checkTampone" onclick="setTampone(<%=OrgDetails.getOrgId() %>,<%=Partita.getCd_seduta_macellazione() %>)" > </th>
    			</tr>
