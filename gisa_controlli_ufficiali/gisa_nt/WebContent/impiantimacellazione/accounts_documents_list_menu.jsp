...
<div id="menuFileContainer" class="menu">
  <div id="menuFileContent">
    <table id="menuFileTable" class="pulldown" width="170" cellspacing="0">
      <dhv:permission name="impiantiMacellazione-impiantiMacellazione-documents-view">
      ...
      <dhv:permission name="impiantiMacellazione-impiantiMacellazione-documents-edit">
      ...
      <dhv:permission name="impiantiMacellazione-impiantiMacellazione-documents-delete">
