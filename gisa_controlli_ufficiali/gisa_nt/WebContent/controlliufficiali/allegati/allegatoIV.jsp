...
Tipologia struttura <input type="text" class="layout" readonly value=""><br>
Orientamento produttivo <input size="60" type="text" class="layout" readonly value="<%=Allevamento.getTipologia_att() %>"><br>
<br>
<br>
</div>
<br>
