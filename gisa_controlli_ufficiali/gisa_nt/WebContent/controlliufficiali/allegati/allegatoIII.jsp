...
N. totale dei vitelli presenti <input type="text" class="layout" readonly value=""> n. dei vitelli di età &lt; a 8 settimane<br>
Capacità massima vitelli <input type="text" class="layout" readonly value=""><br>
<br>
</div>
<br>
<br>
