...
<!--		<li id="tab_test_bse"><a href="#tabs-14" >Test BSE</a></li> 	-->
        ...
        <li id="li-3" style="display: <%= update ? "" : "none" %>;" ><a href="#tabs-3" onclick="javascript:showHide('show');settaSoloCD('false');refreshProspettoAnimale('vpm'); refreshDaVisitaAM();" >Evidenza Visita PM</a></li>
...
<!--             </tr> -->
            ...
            <tr class="containerBody">
              ...
              <td valign="middle">
              	<input type="checkbox" id="cd_vincolo_sanitario_piano"  name="cd_vincolo_sanitario_piano"  onclick="check_uncheck_all('cd_piano_risanamento',3, this.checked);" <%=(Capo.isCd_vincolo_sanitario_piano()) ? ("checked=\"checked\"") : ("") %> />
                Piani risanamento 
                 <input type = "radio" id = "cd_piano_risanamento_1" name = "cd_piano_risanamento"  onclick="javascript:if(this.checked){form.cd_vincolo_sanitario_piano.checked=true;}" value = "1" <%if(Capo.getCd_piano_risanamento()==1){%>checked="checked"<%} %> />BRC
             ...
             <tr class="containerBody">
              ...
              <td valign="middle">
              	<input type="checkbox" id="cd_qualifica_sanitaria_tbc" name="cd_qualifica_sanitaria_tbc" onclick="check_uncheck_all('cd_qualifica_tbc',3, this.checked);" <%=(Capo.isCd_qualifica_sanitaria_tbc()) ? ("checked=\"checked\"") : ("") %> />
				TBC<br> 
                <input type = "radio" id = "cd_qualifica_tbc_1" name = "cd_qualifica_tbc" onclick="javascript:if(this.checked){form.cd_qualifica_sanitaria_tbc.checked=true;}" value = "1" <%if(Capo.getCd_qualifica_tbc()==1){%>checked="checked"<%}%> /> Ufficialmente indenne
                <input type = "radio" id = "cd_qualifica_tbc_2" name = "cd_qualifica_tbc" onclick="javascript:if(this.checked){form.cd_qualifica_sanitaria_tbc.checked=true;}" value = "2" <%if(Capo.getCd_qualifica_tbc()==2){%>checked="checked"<%}%> /> Focolaio 
                <input type = "radio" id = "cd_qualifica_tbc_3" name = "cd_qualifica_tbc" onclick="javascript:if(this.checked){form.cd_qualifica_sanitaria_tbc.checked=true;}" value = "3" <%if(Capo.getCd_qualifica_tbc()==3){%>checked="checked"<%}%> /> Sospesa 
             <br>
              	<input type="checkbox" id = "cd_qualifica_sanitaria_brc" name="cd_qualifica_sanitaria_brc" onclick="check_uncheck_all('cd_qualifica_brc',2, this.checked);" <%=(Capo.isCd_qualifica_sanitaria_brc()) ? ("checked=\"checked\"") : ("") %> />
                BRC<br>
				<input type = "radio" id = "cd_qualifica_brc_1" name = "cd_qualifica_brc" onclick="javascript:if(this.checked){form.cd_qualifica_sanitaria_brc.checked=true;}" value = "1" <%if(Capo.getCd_qualifica_brc()==1){%>checked="checked"<%} %> /> Ufficialmente indenne
                <input type = "radio" id = "cd_qualifica_brc_2" name = "cd_qualifica_brc" onclick="javascript:if(this.checked){form.cd_qualifica_sanitaria_brc.checked=true;}" value = "2" <%if(Capo.getCd_qualifica_brc()==2){%>checked="checked"<%} %> /> Focolaio 
             </td>
            </tr>
		            	...
		            	<tr class="containerBody" style="display: block;">
		                	<td>
		                		1. <input 
		                				...
		                				onblur="javascript:form.vpm_veterinario.value=this.value;"
			            ...
			            <tr 
			                ...
			                <td>
				                2. <input 
		                				...
		                				onblur="javascript:form.vpm_veterinario_2.value=this.value;"
			            ...
			            <tr 
			                ...
			                <td>
				                3. <input 
		                				...
		                				onblur="javascript:form.vpm_veterinario_3.value=this.value;" 
				                		size="35" 
				                		id="cd_veterinario_3"  
        ...
        <td><label id="prospetto_sesso_vam"></label></td>
            ...
            <tr>
             ...
             <tr class="containerBody">
              ...
              <td>
              <input type="radio" id="vam_compilare1" name="vam_compilare" value="1" onClick="gestisciCompilare(1)" checked/> COMPILARE
              <input type="radio" id="vam_compilare0" name="vam_compilare" value="0" onClick="gestisciCompilare(0)"/> NON COMPILARE
              </td>
            </tr>
