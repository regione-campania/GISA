...
function performAction(risposta)
{
	...
	if(risposta=='si')
	{
		...
		{
			window.opener.document.details.action='TroubleTicketsDocumentsAllerteNew.do?command=Add&tipoAlimenti='+tipo_alimenti+'&specie_alimenti='+specie_alimenti+'&id='+idAllerta+'&parentId=-1&folderId=-1&documentiAllerta=1&chiusuraUfficio=1';
		}
		else
		{
			window.opener.document.details.action='TroubleTicketsDocumentsAllerteNew.do?command=Add&tipoAlimenti='+tipo_alimenti+'&specie_alimenti='+specie_alimenti+'&id='+idAllerta+'&parentId=-1&folderId=-1&documentiAllerta=1';
	...
	else
	{
		if (chiusuraUfficio == '1')
		{
			window.opener.document.details.action='TroubleTicketsAllerteNew.do?command=ChiudiAllerta&tipoAlimenti='+tipo_alimenti+'&specie_alimenti='+specie_alimenti+'&chiusuraUfficio=1&id='+idAllerta;
		}
		else
		{
			window.opener.document.details.action='TroubleTicketsAllerteNew.do?command=ChiudiAllerta&tipoAlimenti='+tipo_alimenti+'&specie_alimenti='+specie_alimenti+'&id='+idAllerta;
		}
		window.opener.document.details.submit();
	...
	else
	{
		...
		if (numero_cu_seguiti>=0 )
		{
			if(risposta=='si' )
			{
				...
				if (chiusuraUfficio == 1)
				{
					window.opener.document.details.action='TroubleTicketsDocumentsAllerteNew.do?command=Add&motivazioni=true&tipoAlimenti='+tipo_alimenti+'&specie_alimenti='+specie_alimenti+'&tId='+idAllerta+'&parentId=-1&folderId=-1&documentiAllerta=1&chiusuraUfficio=1';
				}
				else
				{
					window.opener.document.details.action='TroubleTicketsDocumentsAllerteNew.do?command=Add&motivazioni=true&tipoAlimenti='+tipo_alimenti+'&specie_alimenti='+specie_alimenti+'&tId='+idAllerta+'&parentId=-1&folderId=-1&documentiAllerta=1';
		...
		if (numero_cu_seguiti>=0 )
		{
			...
			else
			{
				...
				if (chiusuraUfficio == 1)
				{
					 ...
					 window.opener.open('TroubleTicketsAllerteNew.do?command=GoChiudiAllerta&tipoAlimenti='+tipo_alimenti+'&specie_alimenti='+specie_alimenti+'&id='+idAllerta+'&parentId=-1&folderId=-1&documentiAllerta=1&chiusuraUfficio=1',null,
