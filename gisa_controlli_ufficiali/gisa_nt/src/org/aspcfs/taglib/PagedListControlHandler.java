...
public class PagedListControlHandler extends TagSupport implements TryCatchFinally {
  ...
  public void doCatch(Throwable throwable) throws Throwable {
	  System.out.println("WARNING! Anomalia nel codice");
  }
    ...
    try {
      ...
      if (pagedListInfo != null) {
        ...
        if (enableJScript) {
          ...
          sb.append("<SCRIPT LANGUAGE=\"JavaScript\" TYPE=\"text/javascript\" SRC=\"javascript/pageListInfo.js\"></SCRIPT>");
        }
        ...
        sb.append(pagedListInfo.getListPropertiesHeader(name));
        out.write("<tr>");
        sb.append("<tr>");
        out.write("<td valign=\"middle\" " + "align=\"center\"" + ((bgColor != null) ? " bgColor=\"" + bgColor + "\"" : "")
            + ((tdClass != null) ? " class=\"" + tdClass + "\"" : "") + " width=\"100%\">");
        sb.append("<td valign=\"middle\" " + "align=\"center\"" + ((bgColor != null) ? " bgColor=\"" + bgColor + "\"" : "")
            + ((tdClass != null) ? " class=\"" + tdClass + "\"" : "") + " width=\"100%\">");
        out.write("<input type=\"hidden\" name=\"offset\" value=\"\">");
        sb.append("<input type=\"hidden\" name=\"offset\" value=\"\">");
        out.write("<input type=\"hidden\" name=\"pagedListInfoId\" value=\"" + object + "\">");
        sb.append("<input type=\"hidden\" name=\"pagedListInfoId\" value=\"" + object + "\">");
        if (systemStatus != null) {
          ...
          if (!abbreviate) {
            ...
            sb.append(getLabel(map, systemStatus.getLabel("pagedListInfo.pagedListControlHandler.notAbbreviation")));
          } else {
            out.write(getLabel(map, systemStatus.getLabel("pagedListInfo.pagedListControlHandler.abbreviation")));
            sb.append(getLabel(map, systemStatus.getLabel("pagedListInfo.pagedListControlHandler.abbreviation"))) ;
            out.write("&nbsp;&nbsp;");
            sb.append("&nbsp;&nbsp;");
          }
          out.write("<input type=\"submit\" value=\"" + systemStatus.getLabel("button.go") + "\">");
          sb.append("<input type=\"submit\" value=\"" + systemStatus.getLabel("button.go") + "\">");
        } else {
          ...
          sb.append("[" + pagedListInfo.getPreviousPageLink("<font class='underline'>Previous</font>", "Previous", form) + "|"
              + pagedListInfo.getNextPageLink("<font class='underline'>Next</font>", "Next", form) + "] ");
          ...
          sb.append("Page " + pagedListInfo.getNumericalPageEntry() + " ");
          if (!abbreviate) {
            out.write("of " + ((pagedListInfo.getNumberOfPages() == 0) ? "1" : String.valueOf(pagedListInfo.getNumberOfPages())) + ", ");
            sb.append("of " + ((pagedListInfo.getNumberOfPages() == 0) ? "1" : String.valueOf(pagedListInfo.getNumberOfPages())) + ", ");
            ...
            sb.append("Items per page: " + pagedListInfo.getItemsPerPageEntry(quotesAll + " "));
        ...
        if (batchHTML != null) {
          ...
          sb.append("<tr><td valign=\"middle\" align=\"center\"" + ((bgColor != null) ? " bgColor=\"" + bgColor + "\"" : "")
                  + ((tdClass != null) ? " class=\"" + tdClass + "\"" : "") + " nowrap>");
        ...
        sb.append(pagedListInfo.getListPropertiesFooter());
        out.write("</table>");
        sb.append("</table>");
