 ...
 */
public class AslHandler extends TagSupport implements TryCatchFinally {
          ...
          if (thisContact != null) {
        	  ...
        	  if (thisUser.getSiteId()>0)
                this.pageContext.getOut().write(
                    StringUtils.jsStringEscape(thisUser.getSiteIdName()));
        	  else
        		  this.pageContext.getOut().write("TUTTE LE ASL");
