 ...
 *
 * @author
 * @version $Id: DocumentStoreManagementFiles.java 15745 2006-09-01 18:44:15Z matt $
 * @created
 */
public final class DocumentStoreManagementFilesAsl extends CFSModule {
  ...
  public String executeCommandUpload(ActionContext context) {
    ...
    try {
      ...
      if ((Object) parts.get("id" + documentStoreId) instanceof FileInfo) {
        ...
        if (newFileInfo.getSize()<=2000000){
        ...
        if (recordInserted && isValid) {
          if (thisItem.isImageFormat()) {
            ...
            errors.put(
                "actionError", "File troppo grande. (max 2 MB)");
  ...
  public String executeCommandDelete(ActionContext context) {
    ...
    try {
      ...
      context.getRequest().setAttribute("documentStoreId", documentStoreId);
      // Load the file
      org.aspcfs.modules.documents.base.FileItem thisItem = new org.aspcfs.modules.documents.base.FileItem(
          db, Integer.parseInt(itemId), thisDocumentStore.getId(), Constants.DOCUMENTS_DOCUMENTS);
      ...
      thisItem.delete(db, user.getUserId());
