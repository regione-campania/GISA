 ...
 *
 * @author
 * @version $Id: DocumentStorePermissionCategoryLookup.java 19991 2007-03-09 19:48:21Z matt $
 * @created
 */
public class DocumentStorePermissionCategoryLookup extends GenericBean {
  ...
  public boolean insert(Connection db,ActionContext context) throws SQLException {
    ...
    id = DatabaseUtils.getNextSeq(db,context, "lookup_document_store_permission_category","code");
