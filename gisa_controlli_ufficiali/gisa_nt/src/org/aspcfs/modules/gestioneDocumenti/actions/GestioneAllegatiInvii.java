...
public class GestioneAllegatiInvii extends CFSModule {
	...
	public String allegaFile(ActionContext context,int userId) throws IOException, SQLException, IllegalStateException, ServletException, FileUploadException{
	...
	public String chiamaServerDocumentale(ActionContext context) throws SQLException, IOException{
		...
		String url = "http://srvDOCUMENTALEL"+ApplicationProperties.getProperty("APP_PORTA_DOCUMENTALE")+"/"+ApplicationProperties.getProperty("APP_DOCUMENTALE_INVII_CARICA");
		//STAMPE
		String revDoc = null ;
		URL obj;
		try {
...
public String chiamaServerDocumentale(ActionContext context,int userId) throws SQLException, IOException
{
	...
	HttpURLConnection conn = null;
	String lista_url = "http://srvDOCUMENTALEL"+ApplicationProperties.getProperty("APP_PORTA_DOCUMENTALE")+"/"+ApplicationProperties.getProperty("APP_DOCUMENTALE_LISTA_ALLEGATI_INVII");
	//STAMPE
...
public String allegaFile(ActionContext context,int userId,String ambiente,UserBean u,Hashtable systemStatus,ConnectionElement ce) throws IOException, SQLException, IllegalStateException, ServletException, FileUploadException{
