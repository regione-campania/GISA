...
public class ToAdd extends GenericAction implements Specie
{
	...
	public void execute() throws Exception
	{
		...
		ArrayList<LookupEsameCitologicoDiagnosi> diagnosi = (ArrayList<LookupEsameCitologicoDiagnosi>) persistence.createCriteria( LookupEsameCitologicoDiagnosi.class ).list();
